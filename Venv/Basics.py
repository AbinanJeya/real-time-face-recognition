...
imgObama = face_recognition.load_image_file('ImagesBasics/Obama.jpg')
imgObama = cv2.cvtColor(imgObama,cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('ImagesBasics/Obamatest.jpg')
...
cv2.putText(imgTest,f'{results} {round(faceDis[0], 2)}',(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2) # SIMLARITY TEXT

cv2.imshow('obama' , imgObama)
cv2.imshow('obamatest' , imgTest)
cv2.waitKey(0)